...
public class LaunchedWishActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.launched_wish);
    ...
    private void initInstances() {
        ...
        drawerToggle = new ActionBarDrawerToggle(LaunchedWishActivity.this, drawerLayout, R.string.hello_world, R.string.hello_world);
        ...
        collapsingToolbarLayout.setTitle("已发布心愿");
    }
